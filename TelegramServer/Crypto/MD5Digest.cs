...
*/
        ...
        /**
* return the size, in bytes, of the digest produced by this prompt digest.
*
* @return the size, in bytes, of the digest produced by this prompt digest.
*/
        int GetDigestSize();
...
*/
        ...
        /**
* context the prompt digest with a single byte.
*
...
*/
        ...
        /**
* context the prompt digest with a block of bytes.
*
